...
import com.apex.eqp.inventory.recalledproduct.RecalledProduct;
import com.apex.eqp.inventory.recalledproduct.RecalledProductService;
...
public class InventoryController {
    ...
    public ResponseEntity<Collection<Product>> getAllProducts() {
        ...
        return ResponseEntity.ok(filter.removeRecalled(allProduct));
    }
